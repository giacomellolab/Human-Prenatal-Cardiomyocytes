...
```{r}
p2 <- DimPlot(seu, reduction = "umap",  cols = fill2, label.size = 6, pt.size = 1.5,  label='TRUE') + scale_color_manual(labels = new.cluster.ids, values = fill2) + labs(color = "")
p2
...
DimPlot(seu_Muscle, reduction = "umap", cols = fill4, pt.size = 2.0, label='F')
```
...
d +
  ...
  annotate ("rect", xmin = 47.5, xmax = 59.5, ymin = 0, ymax = 6.5, alpha = .1, fill = "blue") 
...
Choose which ontology
BP = biological processes, MF = molecular function, CC = cellular component
...
```{r fig1C, fig.height = 8.5, fig.width = 12, fig.align = "center"}
#head(as.data.frame(ck))
...
```{r fig2B, fig.height = 12, fig.width = 8, fig.align = "center"}
